...
var input_filename = path.resolve(data + 'raw/ne-hotel-images.csv');
var output_filename = data + 'ne-hotel-images-map.json';
...
data.forEach(function (h) {
  ...
  if (!h.ScreenSizeName.match(/standing/i) &&
    (h.Width === '380' || h.Width === '696' ||  h.Width === '1280')) {
